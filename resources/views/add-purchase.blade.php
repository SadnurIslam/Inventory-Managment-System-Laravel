...
<div class="card shadow-sm">
    <div class="card-header bg-info text-white">
        <div class="row py-2">
            ...
            <div class="col-8">
                <h4 class="text-left">Add New Purchase</h4>
            </div>
        </div>
    </div>
    ...
    <form action="{{route('purchase.store')}}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="quantity" name="expiry_date" value="{{old('expiry_date')}}">
                    @error('expiry_date')
                        <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="quantity" name="supplier_name" value="{{old('supplier_name')}}">
                    @error('supplier_name')
                        <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
